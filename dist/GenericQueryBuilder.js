...
exports.GenericQueryBuilder = void 0;
class GenericQueryBuilder {
    ...
    _extract_having_parts(key, key_array) {
        ...
        if ((m = str_condition.exec(key))) {
            ...
            throw new Error('An invalid condition was supplied (' +
                key +
    ...
    _escape_identifiers(item = '*', split = true) {
        ...
        if (Object.prototype.toString.call(item) ===
            ...
            return this._escape_identifiers_string(item, split);
        }
    }
    _escape_identifiers_string(item, split = true) {
    ...
    _protect_identifiers(item, prefix_single = false, protect_identifiers = null, field_exists = true) {
        ...
        if (typeof item !== 'string')
            throw new Error('Invalid item passed to _protect_identifiers:' + typeof item);
    ...
    _track_aliases(table) {
        if (Object.prototype.toString.call(table) ===
            Object.prototype.toString.call({})) {
            for (let i in table) {
                const t = table[i];
    ...
    where(key, value = null, escape = true) {
        if (Object.prototype.toString.call(key) ===
            Object.prototype.toString.call({}) &&
    ...
    _like(field, match, type = 'AND ', side = 'both', not = '') {
        ...
        if (Object.prototype.toString.call(field) !==
            Object.prototype.toString.call({})) {
            if (match === null) {
            ...
            if (side === 'none') {
                ...
                if (typeof v === 'string') {
                    like_statement =
                        k +
                            not +
                            ` LIKE ${v.substr(0, 1)}%${v.substr(1, v.length - 2)}%${v.slice(-1)}`;
                }
                else {
                    like_statement = k + not + ` LIKE %${v}%`;
                }
    ...
    _having(key, value, type = 'AND ', escape = true) {
        let m;
        let key_array = {};
        const key_is_object = Object.prototype.toString.call(key) ===
            Object.prototype.toString.call({});
    ...
    set(key, value, escape = true) {
        ...
        if (typeof key === 'string') {
            ...
            throw new Error('set(): First parameter must be a non-empty string or non-empty object! ' +
                typeof key +
                ' provided.');
        }
        for (let i in key) {
            ...
            if (!/^(number|string|boolean)$/.test(typeof v) &&
                v !== null &&
                escape === false) {
                throw new Error('set(): Invalid value provided! (provided: ' +
                    v +
                    ' (type: ' +
                    typeof v +
                    ')');
    ...
    _insert(table = '', set = '', ignore = false, suffix = '') {
        ...
        if (/^(number|boolean)$/.test(typeof set) ||
        ...
        if (set !== null) {
            if (Object.prototype.toString.call(set) ===
                Object.prototype.toString.call({}) &&
    ...
    _update(table = '', set = null, where = null) {
        ...
        if (Array.isArray(set)) {
            let index = null;
            if (set.length > 0) {
                if (Object.prototype.toString.call(set[0]) ===
                    Object.prototype.toString.call({})) {
    ...
    _update_batch(table = '', set = null, index = null, where = null) {
        ...
        for (let i in set) {
            const clean = {};
            const row = set[i];
            if (Object.prototype.toString.call(row) ===
                Object.prototype.toString.call({}) &&
